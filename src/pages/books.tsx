        ...
        <div className="bg-white lg:min-h-[100vh]">
            <div>
                <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="relative z-10 flex-row-start-start  pt-10 pb-6 border-b border-gray-200">
                        <h1 className="text-3xl font-bold tracking-tight text-gray-900 mb-10">Books</h1>
                                    ...
                                    if (isSearch) {
                                        getBooks({
                                            variables: {
                                                title: searchQuery,
                                                bookcategory:
                                                    categoryFilter.length == 0 ? defaultCatArray : categoryFilter,
                                                author: authorFilter.length == 0 ? defaultAuthorArray : authorFilter,
                                                sort: sort,
                                                page: page,
                                                pageSize: _pageSize,
                    ...
                    <section aria-labelledby="products-heading" className="pt-6 pb-24">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
                            ...
                            {/* Product grid */}
                            <div className="flex-col-center-start lg:col-span-3">
                                <div className="flex-row-center-start w-full min-h-[80vh]  flex-wrap p-10 gap-10 border-4 border-dashed border-gray-200 rounded-lg lg:h-full">
                                    {loading && (
                                    ...
                                    {!loading && bookList && isMore && (
                                        <div className="h-40 w-full flex-row-center-center mt-10">
                                            <Button
                                                ...
                                                href=""
                                                isDark={true}
                                                style="!h-[35px] w-40 bg-indigo-600 hover:!bg-indigo-700"
